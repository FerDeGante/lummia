...
export const BRAND_ASSETS = {
  logo: "https://res.cloudinary.com/ddax9tdki/image/upload/v1774491388/lummia_logo_maceqz.png",
  icon: "https://res.cloudinary.com/ddax9tdki/image/upload/v1774491389/lummia_icon_uziej1.png",
};

export const HERO_CHIPS = [
  "Curaduría local",
  "Experiencia premium",
  "Comunidad que regresa",
];

export const HERO_FLOATING_PANELS = [
  { label: "Marcas locales", position: "left-3 top-10 sm:left-6 sm:top-14" },
  { label: "Espacios con intención", position: "right-5 top-20 sm:right-8 sm:top-16" },
  { label: "Próxima apertura", position: "bottom-8 left-10 sm:bottom-10 sm:left-18" },
];

export const STORY_STEPS = [
  "No es solo una tienda.",
  "Es visibilidad para marcas con identidad.",
  "Es un destino para personas que quieren descubrir algo real.",
];

export const STORY_SUPPORT =
  "Lúmmia convierte una visita en experiencia, y una marca en una presencia que se recuerda.";
...
export const BENEFITS = [
  {
    title: "Visibilidad física en ubicación estratégica",
    text: "Tu marca gana presencia donde la gente sí entra, mira y descubre con intención.",
  },
  {
    title: "Junto a otras marcas locales",
    text: "Compartes contexto con propuestas que elevan la percepción de tu espacio.",
  },
  {
    title: "Comunidad que recomienda y regresa",
    text: "La visita no termina en el momento: puede convertirse en relación y recurrencia.",
  },
  {
    title: "Difusión digital alineada con la experiencia física",
    text: "Lo que se ve en redes aterriza en una experiencia con más valor y mejor conversión.",
  },
];

export const OPENING_CHIPS = [
  "Apertura en construcción",
  "Captación elegante",
  "Experiencia que convierte",
];

export const LOCATION = {
  address: "Calle Galeana s/n, Centro, Cuernavaca, Morelos.",
  hours: "Lun a dom · 10:00 a 19:00",
  whatsappLabel: "Resolver dudas por WhatsApp",
  whatsappUrl:
    "https://wa.me/527211005506?text=Hola%2C%20quiero%20resolver%20dudas%20sobre%20L%C3%BAmmia",
  mapsUrl: "https://maps.app.goo.gl/mXshcmwJ8jKDypVP7",
  mapsEmbed:
    "https://www.google.com/maps?q=Calle+Galeana+s%2Fn%2C+Centro%2C+Cuernavaca%2C+Morelos&output=embed&z=16&hl=es",
};

export const SOCIAL = {
  instagram: "https://www.instagram.com/lummia.cuerna/",
  facebook: "https://www.facebook.com/share/18Hwj9e26n/?mibextid=wwXIfr",
};

export const INSTAGRAM_POSTS = [
  "https://res.cloudinary.com/ddax9tdki/image/upload/v1774494496/Captura_de_pantalla_2026-03-25_a_la_s_9.08.11_p.m._clyksm.png",
  "https://res.cloudinary.com/ddax9tdki/image/upload/v1774494494/Captura_de_pantalla_2026-03-25_a_la_s_9.08.02_p.m._bgqhnz.png",
  "https://res.cloudinary.com/ddax9tdki/image/upload/v1774494485/Captura_de_pantalla_2026-03-25_a_la_s_9.07.51_p.m._inxafe.png",
  "https://res.cloudinary.com/ddax9tdki/image/upload/v1774494474/Captura_de_pantalla_2026-03-25_a_la_s_9.07.41_p.m._ocfhsb.png",
];
